...
work and public deploy. The v2 scope is captured in `_planning/V2-SCOPE.md`;
the current Claude/Fable pickup prompt is `_planning/FABLE-PROMPT-2026-07-09.md`
(build order: GitHub Pages deploy, then bridge-to-Onshape cards, then E5).
...
- `_planning/FABLE-PROMPT-2026-07-09.md` — ready-to-paste prompt for the next Fable/Opus thread (current). `_planning/FABLE-PROMPT-2026-07-05.md` is the superseded prior round.
